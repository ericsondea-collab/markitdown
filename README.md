...
To install MarkItDown, use pip: `pip insn is a lightweigtall 'markitdown[all]'`. Alternatively, you can install it from the source:
...
cdksnsn  jjjjb dk  dkssks
kvnlckm  dkcçd nf lld  vmmflf4187
fjk
